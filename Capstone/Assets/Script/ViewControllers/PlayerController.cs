...
namespace SkateGame
{
    ...
    public class PlayerController : ViewerControllerBase
    {
        ...
        private T SafeGetComponent<T>(GameObject o) where T: MonoBehaviour
        {
            T comp1 = o.GetComponent<T>();
            CodeReferencer comp2 = o.GetComponent<CodeReferencer>();
            if (comp1 != null)
            {
                return comp1;
            }
            ...
            {
                if (comp2 != null && comp2.reference is T)
                    return comp2.reference as T;
